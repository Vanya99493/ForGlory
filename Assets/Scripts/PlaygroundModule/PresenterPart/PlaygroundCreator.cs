...
namespace PlaygroundModule.PresenterPart
{
    public class PlaygroundCreator
    {
        ...
        public CellPresenter[,] CreatePlaygroundByNewRootSpawnSystem(int height, int width, CellDataProvider cellDataProvider)
        {
            ...
            int heightStartIndex = Random.Range(0, height);
            int widthStartIndex = Random.Range(0, width);
